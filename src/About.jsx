...
function AboutPage() {
    ...
    const features = [
        { id: 1, icon: <VoiceIcon />, title: "التعرف على الصوت", description: "تقنية متقدمة للتعرف على الأوامر الصوتية بدقة عالية" },
        { id: 2, icon: <BrainIcon />, title: "الذكاء الاصطناعي", description: "يستخدم نماذج ذكاء اصطناعي متطورة لفهم السياق" },
        { id: 3, icon: <BoltIcon />, title: "استجابة فورية", description: "معالجة سريعة وردود في أقل من ثانية" },
        { id: 4, icon: <GlobeIcon />, title: "متعدد اللغات", description: "دعم للعربية والإنجليزية والعديد من اللغات" },
        { id: 5, icon: <ShieldIcon />, title: "آمن وخاص", description: "حماية كاملة لبياناتك وخصوصيتك" },
        { id: 6, icon: <DevicesIcon />, title: "متعدد المنصات", description: "يعمل على الويب، الموبايل، والأجهزة الذكية" }
    ];
                ...
                >
                    ...
                    <div className="tech-stack">
                        <div className="tech-item">
                            <motion.span className="tech-badge" whileHover={{ y: -3 }}>React</motion.span>
                            <motion.span className="tech-badge" whileHover={{ y: -3 }}>Framer Motion</motion.span>
                            <motion.span className="tech-badge" whileHover={{ y: -3 }}>Web Speech API</motion.span>
                            <motion.span className="tech-badge" whileHover={{ y: -3 }}>AI/ML Models</motion.span>
                            <motion.span className="tech-badge" whileHover={{ y: -3 }}>WebGL</motion.span>
                            <motion.span className="tech-badge" whileHover={{ y: -3 }}>Vite</motion.span>
                        </div>
                    </div>
                </motion.div>
            </section>
